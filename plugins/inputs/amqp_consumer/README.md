...
Message payload should be formatted in one of the [Telegraf Data Formats](https://gitee.com/zhimiao/qiansi-telegraf/blob/master/docs/DATA_FORMATS_INPUT.md).
