...
type UdpListener struct {
	...
	// into the in channel
	// see https://gitee.com/zhimiao/qiansi-telegraf/pull/992
...
const sampleConfig = `
  ...
  # see https://gitee.com/zhimiao/qiansi-telegraf/tree/master/plugins/inputs/socket_listener
`
...
func (u *UdpListener) Start(acc telegraf.Accumulator) error {
	...
	log.Println("W! DEPRECATED: the UDP listener plugin has been deprecated " +
		...
		"(https://gitee.com/zhimiao/qiansi-telegraf/tree/master/plugins/inputs/socket_listener)")
