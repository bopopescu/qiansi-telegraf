...
const sampleConfig = `
  ...
  # jolokia2 plugin
  # see https://gitee.com/zhimiao/qiansi-telegraf/tree/master/plugins/inputs/jolokia2
...
func (j *Jolokia) Gather(acc telegraf.Accumulator) error {
	...
	if j.jClient == nil {
		log.Println("W! DEPRECATED: the jolokia plugin has been deprecated " +
			...
			"(https://gitee.com/zhimiao/qiansi-telegraf/tree/master/plugins/inputs/jolokia2)")
