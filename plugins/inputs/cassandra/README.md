...
### **Deprecated in version 1.7**: Please use the [jolokia2](https://gitee.com/zhimiao/qiansi-telegraf/tree/master/plugins/inputs/jolokia2) plugin with the [cassandra.conf](/plugins/inputs/jolokia2/examples/cassandra.conf) example configuration.
